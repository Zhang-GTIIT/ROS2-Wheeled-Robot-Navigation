...
# ========== 可配置参数 ==========
MAP_YAML="/home/agv/wzb/map/gf/scans.yaml"
NAV2_PARAMS="$ROOT_DIR/nav2_params4connect.yaml"
RVIV_CONFIG="$ROOT_DIR/nav2_default_view.rviz"
ICP_PARAMS="$ROOT_DIR/src/icp_localization_ros2/config/node_paramsgf.yaml"
